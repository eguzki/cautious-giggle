...
# giggle.kuadrant.io/cautious-giggle-bundle:$VERSION and giggle.kuadrant.io/cautious-giggle-catalog:$VERSION.
IMAGE_TAG_BASE ?= giggle.kuadrant.io/cautious-giggle
...
$(OPERATOR_SDK):
	...
	OS=$(shell go env GOOS) && ARCH=$(shell go env GOARCH) && \
		curl -sSLv $(OPERATOR_SDK_DL_URL)/operator-sdk_$${OS}_$${ARCH} -o $(OPERATOR_SDK)
